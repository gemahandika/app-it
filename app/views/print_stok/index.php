<main>
    <div class="container-fluid px-4">
        <h5 class="mt-4 fw-bold" style="border-bottom: 1px solid black;">Data Stok Printer Label </h5>
        <div class="card mb-4 mt-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex flex-wrap gap-2">
                    <button class="btn bg-cantik text-white btn-sm button1-hover" data-bs-toggle="modal" data-bs-target="#modalStokPrinter">
                    ...
                    <table id="example" class="display nowrap" style="width:100%">
                        <thead>
                            <tr class="bg-cantik text-white">
                                ...
                                <th class="small text-center">DATE TERIMA</th>
                        ...
                        <tbody id="karyawanResult">
                            <?php
                            extract($data);
                            require_once '../app/views/print_stok/_partial_tabel_print_stok.php';
                            ?>
                        </tbody>
                    </table>
                </div>

                <!-- Modal Tambah Stok Printer -->
                <div class="modal fade" id="modalStokPrinter" tabindex="-1" aria-labelledby="modalStokPrinterLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        <div class="modal-content">
                            <form action="<?= BASE_URL; ?>/print_stok/tambah" id="formStokPrinter" method="POST">
                                <div class="modal-header bg-cantik text-white">
                                    <h5 class="modal-title" id="modalStokPrinterLabel">Tambah Stok Printer</h5>
                                ...
                                <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="serial_number" id="tambah-serial_number" class="form-control fw-bold" required>
                                        </div>
                                    </div>
